...
@pytest.mark.parametrize(("test_input", "expected"), MISC_TEST_CASES)
def test_misc_chinese_names(detector, test_input, expected):
    """Test miscellaneous Chinese name detection scenarios."""
    assert_normalized_name(detector, test_input, expected)
