...
CHINESE_NAME_TEST_CASES = [
    ...
    ("D. W. Wang", (True, "D-W Wang")),    ("X. Han", (True, "X Han")),
    ("L Han", (True, "L Han")),
    ...
    ("Li Lili", (True, "Li-Li Li")),  # System uses hyphens    ("Tu Youyou", (True, "You-You Tu")),  # System uses hyphens for reduplicated names
    ...
    ("Chen An", (True, "An Chen")),  # an as given name    # Korean surname overlap fix verification    # Names with overlapping surnames    # Ambiguous Surname + Common Word    # Ambiguous ordering patterns    # Edge cases with common Chinese names    # Common pattern tests
    ...
    # Very unusual but valid patterns
