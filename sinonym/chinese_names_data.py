...
NAME_ORDER_ROUTING_KOREAN_SURNAMES = frozenset(
    {
        "ahn",
        "an",
        "bae",
...
NAME_ORDER_ROUTING_KOREAN_GIVEN_SYLLABLES = frozenset(
    {
        "ae",
        "bin",
        "bo",
...
NAME_ORDER_ROUTING_CANTONESE_SOUTHEAST_ASIAN_SURNAMES = frozenset(
    {
        "chan",
        "chang",
        "chew",
...
NAME_ORDER_ROUTING_CANTONESE_GIVEN_SYLLABLES = frozenset(
    {
        "boon",
        "chih",
        "ching",
